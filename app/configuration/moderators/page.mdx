...
Moderators are users who can use moderation commands (`/lock`, `/unlock`, `/mute-user-from-interserv-group`, `/unmute-user-from-interserv-group`) in the interserv group.
...
<Callout type="warning">
  Be careful who you designate as a moderator, as they can mute users and lock the group for all connected servers, not just your server.
</Callout>

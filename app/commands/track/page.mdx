...
```
/track message_link:<link>
```

| Parameter | Type | Required | Description |
|---|---|---|---|
| `message_link` | String | Yes | Link to a synced message |
...
1. You provide a message link to a synced message
...
```
/track message_link:https://discord.com/channels/123/456/789
```

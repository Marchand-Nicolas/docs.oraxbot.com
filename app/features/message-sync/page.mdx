...
3. **Filtering** — The message is checked against word blacklists, message filters, and mute lists
...
| **Polls** | Native Discord polls and Fluxer `/poll` are relayed; votes are aggregated on expiry |

...
<Callout type="warning">
  Auto Translate is an **Orax Plus** feature. You need an active Orax Plus subscription (or an active vote) to enable it. See [Orax Plus](/premium) for details.
</Callout>
...
4. If you don't have Orax Plus, you'll be prompted to vote or subscribe

<Callout type="tip">
  Translation is enabled from the dashboard. `/manage-group` does not include this toggle.
</Callout>
...
<Callout type="warning">
  If your Orax Plus subscription expires or your vote period ends, Auto Translate is automatically disabled for your group. Messages will continue to sync normally, but without translation.
</Callout>

## Limitations

- Requires an **active Orax Plus** entitlement (via Stripe subscription or vote)
